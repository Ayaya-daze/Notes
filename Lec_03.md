...
$$\begin{align}&{\large\gamma}_I(\xi,t)\to{\large\gamma}_I(\xi,t)+\partial_I\chi(\xi,t)\\& H(\xi,t)\to H(\xi,t)-\partial_t\chi(\xi,t)\end{align}$$ ^de958e
...
- First: $\omega_{IJ}$ has no intrinsic local information.
